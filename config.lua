...
-- 'auto' detects the running core in this order: qbx_core -> qb-core ->
-- es_extended (qbx must win the tie because it `provide`s qb-core). Set an
-- explicit value only if detection picks the wrong core on a hybrid server.
