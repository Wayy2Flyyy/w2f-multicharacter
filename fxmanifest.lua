...
--   Framework: qbx_core (default), qb-core, or es_extended in multichar mode
--   (ESX 1.13+ needs a stub resource named esx_multicharacter — see esx.md).
--   Set Config.Framework explicitly or leave 'auto' to detect the running core.
